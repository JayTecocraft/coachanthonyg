...
export function FreeTrialBanner() {
  ...
  return (
    <div className="fixed bg-black/80 max-w-xl bottom-5 left-4 box-border right-4 w-auto mx-auto backdrop-blur-md border-2 border-primary/60 text-gray-200 text-center z-50 rounded-xl">
      <div 
        onClick={handleClick}
